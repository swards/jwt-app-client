...
export const App = () => {
  ...
  const signupForm = () => {
    return (
      <div><h3>Sign up</h3>
        <div>Email: <input name='email' value={email} onChange={e => setEmail(e.currentTarget.value)} /></div>
        <div>Password: <input name='password' value={password} onChange={e => setPassword(e.currentTarget.value)} /></div>
        <div>Username: <input name='username' value={username} onChange={e => setUsername(e.currentTarget.value)} /></div>
